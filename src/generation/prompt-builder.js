...
export function buildPrivateGenerationRequest({
  ...
  if (clean(momentsContext)) {
    systemBlocks.push(
      '【手机跨 App 连续性】\n以下内容属于同一个角色在手机世界中已经亲历、已经知道或已经看过的连续性事实，可能来自社区、朋友圈等不同 App。App 只是发生场所：角色在社区真正参与/知道过的事，进入后续私聊或群聊时仍然可以记得；但不得把系统后台真相、未获知的匿名身份或别人的私密经历当成自己知道。看过不等于点赞或评论；没有公开互动也不代表遗忘。可以自然受这些经历影响，但不要每轮强行复述，也不要捏造未记录的行为。\n\n'
