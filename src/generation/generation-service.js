...
export async function generatePublicWebRefresh({ scopeKey, ghostStoriesEnabled = false, section = 'tianya', signal, recommendSources = null, recommendCount = 0, customCommunities = [], weiboQuery = '' } = {}) {
