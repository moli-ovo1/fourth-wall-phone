...
export async function maybeAutoCompactGroupMemory({ scopeKey, conversationKey } = {}) {
  ...
  try {
    ...
    if (!conversation || conversation.type !== 'group') return { changed: false, reason: 'unsupported-conversation' };
