...
import { createPhonePanel } from '../ui/phone-panel.js?v=server-community-trial-4';
import { getCurrentScopeKey } from './tavern-scope.js';
import { createReviewAutomation } from '../automation/review.js';
import { createPrivateAutomation } from '../automation/private-automation.js?v=server-community-trial-4';
