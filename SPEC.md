...
- **固定人格**：moli / 小上帝 / 皮下仍是单入口；正文内优先当前正文实例，正文外优先 Global。这里的“不是正文原生人物”只描述世界/数据归属；**moli230 起不再把它解释为 Community 行为门禁**，三人格可像其他候选人物一样自主浏览、参与或不参与。
...
- moli / 皮下 / 小上帝仍是跨世界固定人格，不属于正文社区原生人物池。**moli230 起废弃“只有 User 主动召入才可进入社区”的行为限制**：世界归属只描述数据来源，不限制固定人格自主浏览或参与 Community。
...
## moli230 / v0.5.83 — Community 自主发现闭环（2026-09-20）
- 删除 `communityNativeRoster()` 中“moli / 皮下 / 小上帝只有 User 主动召入才可进入社区”的行为门禁；保留“非正文原生人物”的数据归属含义。
- 公共 Community 新增与朋友圈 `viewedMomentIds` 同类的自主发现结算：刷新产生的新帖进入存储后，当前世界人物与三位固定人格可独立决定实际浏览哪些帖子；0 人浏览、0 人参与均有效。
- 自主浏览会把当时的帖子快照写入既有 World Event / Awareness，再由统一 `buildPhoneContext()` 跨 App 读取；不新增平行 Community Memory，也不把模型后台可见内容自动视作人物已知。
- 人物看见帖子后可独立选择实名参与、小号参与或沉默。谨慎/身份敏感可以影响身份和行动，但不再充当“没有资格浏览”的门槛。
- 微博生成 Prompt 删除“自然相关时才可参与”的资格措辞，保留“是否行动由人物自身状态与动机决定、无需每轮出现”。
- `community-runtime` 的经历规则改为代码账本边界：只有已实际写入人物 Awareness/经历的事件才能成为后续人物经历；人物获得信息的途径包括自主浏览和实际公开互动，不要求 User 先 @/邀请/转发。
