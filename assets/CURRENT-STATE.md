## moli252 / v0.6.05 — 世界内日历 v1
- 新增主屏幕「日历」App：只保存人物世界里已经存在的未来安排，不承担剧情规划；支持人物归属、时间、备注以及已安排/已完成/已取消/未完成状态。
- 日历接入既有「我们的墙」Source Provider：日程可作为正文连续性材料手动跨墙，明确“有安排 ≠ 已发生/必然发生”，不新增独立正文 injector，也不额外调用 API。
- 本版不自动脑补/生成日程，不与娘家人长线规划或外部综合情报状态栏争夺剧情规划职责；未来统一持续上下文层再决定日历与长短线的自动轻量注入。
